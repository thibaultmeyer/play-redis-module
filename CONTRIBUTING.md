...
This document explains how to contribute changes to the play-redis-module
project.
...
If unique, [open an issue](https://goo.gl/EVD2TF) and answer the questions
...
play-redis-module. This is easiest to do when you write clear, concise
...
Check out [How to Report Bugs Effectively](https://goo.gl/BTcqfc).

Please be kind, remember that play-redis-module comes at no cost to you,
...
Changes to play-redis-module must be reviewed before they are accepted,
...
"[How to get faster PR reviews](https://goo.gl/wKqfEr)" guide, it has lots of
...
* To help the future maintainers of play-redis-module, say five years
